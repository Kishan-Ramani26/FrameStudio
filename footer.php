          ...
          <div class="footer-bottom-wrap">
            ...
            <div class="copyright-link-wrap"><a href="/references/style-guide" class="copyright-link paragraph-04">Style
              ...
              <div class="horizontal-divider"></div><a href="/references/license"
                class="copyright-link paragraph-04">License </a>
              <div class="horizontal-divider"></div><a href="/references/changelog"
                class="copyright-link paragraph-04">Changelog</a>
              <div class="horizontal-divider"></div><a href="/401" class="copyright-link paragraph-04">Pass
                Protected</a>
            </div>
          </div>
        </div>
    ...
    <script src="js/jquery.js?site=6845c0d2aeb4f8e6515d4444" type="text/javascript"></script>
