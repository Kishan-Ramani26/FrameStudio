(() => {
      ...
      84345: function (e, t, i) {
        ...
        n.define(
          ...
          (e.exports = function (e, t) {
            ...
            function g() {
              (i = f.find(h)).length &&
                (i.each(w), s || (y(), n.resize.on(b), n.redraw.on(l.redraw)));
            }
            function y() {
              n.resize.off(b), n.redraw.off(l.redraw);
            }
            function b() {
            ...
            function w(t, i) {
              ...
              a.el.off(h),
                ...
                x(a),
                d
                  ? (a.el.on("setting" + h, R(a)), L(a), (a.hasTimer = !1))
                  : (a.el.on("swipe" + h, R(a)),
                    a.left.on("click" + h, T(a)),
                    a.right.on("click" + h, j(a)),
                    a.left.on("keydown" + h, E(a, T)),
                    a.right.on("keydown" + h, E(a, j)),
                    a.nav.on("keydown" + h, "> div", R(a)),
                    a.config.autoplay &&
                      !a.hasTimer &&
              ...
              l.addClass(p), m || A(t, i), o.removeClass(p), l.removeClass(p);
            }
            function x(e) {
              var t = {};
              (t.crossOver = 0),
            ...
            function R(i) {
              return function (a, o) {
                ...
                if (d && "setting" === a.type) {
                  ...
                  if ("next" === o.select) return j(i)();
                  if ((x(i), S(i), null == o.select)) return;
                  return (
                    (s = o.select),
                    (l = null),
                    s === i.slides.length && (g(), S(i)),
                    t.each(i.anchors, function (t, i) {
                      e(t.els).each(function (t, n) {
                        e(n).index() === s && (l = i);
                      });
                    }),
                    void (null != l && P(i, { index: l, immediate: !0 }))
                  );
                }
                if ("swipe" === a.type)
                ...
                if (i.nav.has(a.target).length) {
                  ...
                  if (
                    ("click" === a.type && P(i, { index: f }),
                    "keydown" === a.type)
                  )
                    switch (a.keyCode) {
                      case r.ENTER:
                      case r.SPACE:
                        P(i, { index: f }), a.preventDefault();
                        break;
                      case r.ARROW_LEFT:
                      case r.ARROW_UP:
                        C(i.nav, Math.max(f - 1, 0)), a.preventDefault();
                        break;
                      case r.ARROW_RIGHT:
                      case r.ARROW_DOWN:
                        C(i.nav, Math.min(f + 1, i.pages)), a.preventDefault();
                        break;
                      case r.HOME:
            ...
            function P(t, i) {
              ...
              r < 0
                ? ((r = a.length - 1),
                  n.infinite &&
                    ((s.x = -t.endX), (s.from = 0), (s.to = a[0].width)))
                : r >= a.length &&
                  ((r = 0),
                  n.infinite &&
                    ((s.x = a[a.length - 1].width),
                    (s.from = -a[a.length - 1].x),
                    (s.to = s.from - s.x))),
                (t.index = r);
              var l = t.nav
                .children()
              ...
              if (
                ...
                d || (p.each(v.intro), y.each(v.outro)),
                i.immediate && !m)
              ) {
                c(p).set(h), W();
                return;
              ...
              if (t.index !== t.previous) {
                if (
                  (d || t.ariaLiveLabel.text(`Slide ${r + 1} of ${a.length}.`),
                  "cross" === b)
                ) {
            ...
            function S(t) {
              ...
              var l = t.index;
              l >= i && (l = i - 1), P(t, { immediate: !0, index: l });
            }
            return (
              (l.ready = function () {
                (d = n.env("design")), g();
    ...
    (() => {
      ...
      i.t = function (n, a) {
        ...
        for (
          ...
          Object.getOwnPropertyNames(d).forEach((e) => {
            o[e] = () => n[e];
          });
    ...
    (() => {
      ...
      i.O = (t, n, a, r) => {
        ...
        for (var d = 1 / 0, o = 0; o < e.length; o++) {
          for (var [n, a, r] = e[o], s = !0, l = 0; l < n.length; l++)
            (!1 & r || d >= r) && Object.keys(i.O).every((e) => i.O[e](n[l]))
              ? n.splice(l--, 1)
              : ((s = !1), r < d && (d = r));
          if (s) {
            e.splice(o--, 1);
  ...
  var n = i.O(void 0, ["425", "435"], function () {
    return i(22182);
  });
  n = i.O(n);
})();
