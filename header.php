...
<head>
  ...
  <meta content="Frame Studio" property="og:title" />
  <meta
    content="Frame Studio is a modern web agency specializing in creative design, custom websites, and digital experiences. We help brands stand out with clean UI, smooth interactions, and next-gen development."
    property="og:description" />
  <meta content="images/Frame-Studio Logo.png" property="og:image" />
  <meta content="Frame Studio" property="twitter:title" />
  <meta
    content="Frame Studio is a modern web agency specializing in creative design, custom websites, and digital experiences. We help brands stand out with clean UI, smooth interactions, and next-gen development."
    property="twitter:description" />
  <meta content="images/Frame-Studio Logo.png" property="twitter:image" />
  ...
  <link href="images/Frame-Studio Logo.png" rel="shortcut icon" type="image/x-icon" />
  <link href="images/Frame-Studio Logo.png" rel="apple-touch-icon" />
</head>
